...
import numpy as np
A1 = np.loadtxt('C:\\Users\\mishal\\Desktop\\adj_allVillageRelationships_vilno_1.csv', delimiter=',')
A2 = np.loadtxt('C:\\Users\\mishal\\Desktop\\adj_allVillageRelationships_vilno_2.csv',delimiter=',')
...
plt.savefig('C:\\Users\\mishal\\Desktop\\village_relationships.pdf')
